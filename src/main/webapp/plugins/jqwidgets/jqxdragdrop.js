...
(function (a) {
    ...
    a.extend(a.jqx._jqxDragDrop.prototype, {
        defineInstance: function () {
            ...
            this.addHandler(a(document), this._getEvent("mousemove") + ".draggable." + this.element.id, this._mouseMove, {self: this});
            this.addHandler(a(document), this._getEvent("mouseup") + ".draggable." + this.element.id, this._mouseUp, {self: this});
            try {
            ...
            var b = f.data.self, d = b._getMouseCoordinates(f), c = b._mouseCapture(f);
            ...
            var d = this._getMouseCoordinates(e), c = this._getParentOffset(this.host);
            ...
            this._offset = {top: this._offset.top - this.margins.top, left: this._offset.left - this.margins.left};
            a.extend(this._offset, {
                click: {left: d.left - this._offset.left, top: d.top - this._offset.top},
            ...
            var c = this._getRelativeOffset(this.host), b = this.position;
            b = {left: this.position.left + c.left, top: this.position.top + c.top};
            return b
            ...
            return {over: h, target: i}
        }, _handleTarget: function () {
            if (this.dropTarget) {
                var b = this.feedback.offset(), c = this.feedback.outerWidth(), d = this.feedback.outerHeight(), e = this._over(b, c, d);
                if (e.over) {
                    ...
                    if (!this._targetEnterFired || (e.target.length > 0 && this._oldtarget && this._oldtarget.length > 0 && e.target[ 0 ] != this._oldtarget[ 0 ])) {
                        ...
                        this._raiseEvent(3, {target: e.target});
                    ...
                    if (this._targetEnterFired) {
                        ...
                        this._raiseEvent(4, {target: this._oldtarget || e.target});
                        if (this.onDropTargetLeave && typeof this.onDropTargetLeave === "function") {
            ...
            var e = false, b = this._fixPosition(), c = {
            ...
            this._feedbackProportions = {width: this.feedback.outerWidth(), height: this.feedback.outerHeight()}
            ...
            var b = this._positionType == "absolute" && !(this._scrollParent[ 0 ] != document && a.contains(this._scrollParent[ 0 ], this._offsetParent[ 0 ])) ? this._offsetParent : this._scrollParent, i = (/(html|body)/i).test(b[ 0 ].tagName);
            var e = this._getMouseCoordinates(f), d = e.left, c = e.top;
            ...
            var b = this._events[ c ], d = a.Event(b), e = e || {};
            ...
            _hitTestBounds: function (b, c, e) {
                ...
                d.on("dragStart", function (h) {
                    if (c.allowDrag && !c.disabled) {
                        ...
                        var f = function () {
                            c._dragCancel = true;
                            a(h.args.element).jqxDragDrop({triggerEvents: false});
                            a(h.args.element).jqxDragDrop("cancelDrag");
                            clearInterval(c._autoScrollTimer);
                            a(h.args.element).jqxDragDrop({triggerEvents: true});
                            a.each(c._listBoxes, function () {
                                var k = a.data(this, "jqxListBox").instance;
                        ...
                        if (g != null && !g.isGroup) {
                            ...
                            c._raiseEvent(4, {label: g.label, value: g.value, originalEvent: h.args})
                        } else {
                            if (g == null) {
                                f()
                            }
                ...
                c.on("dragEnd", function (f) {
                        ...
                        if (l && !n.disabled) {
                            ...
                            if (p != null && !p.isGroup) {
                                ...
                                if (b.dragEnd) {
                                    ...
                                    if (r == false) {
                                        a(f.args.element).jqxDragDrop({triggerEvents: false});
                                        a(f.args.element).jqxDragDrop("cancelDrag");
                                        clearInterval(b._autoScrollTimer);
                                        a(f.args.element).jqxDragDrop({triggerEvents: true});
                                        if (f.preventDefault) {
                                            f.preventDefault()
                                        }
                    ...
                    if (s != null) {
                        b._raiseEvent(5, {label: s.label, value: s.value, originalEvent: f.args})
                    }
                    return false
                })
                ...
                if (this._isTouchDevice) {
                    ...
                    return {left: b.args.pageX, top: b.args.pageY}
                }
            }
        })
    };
        ...
        a.extend(a.jqx._jqxTree.prototype, {
            _hitTestBounds: function (b, g, f) {
                            ...
                            if (i.length > 0) {
                                ...
                                if (k) {
                                    ...
                                    if (j.dragStart) {
                                        ...
                                        if (h == false) {
                                            c._dragCancel = true;
                                            a(g.args.element).jqxDragDrop({triggerEvents: false});
                                            a(g.args.element).jqxDragDrop("cancelDrag");
                                            clearInterval(c._autoScrollTimer);
                                            a(g.args.element).jqxDragDrop({triggerEvents: j});
                                            return false
                                        }
                                    }
                                    j._raiseEvent(8, {label: k.label, value: k.value, originalEvent: g.args})
                                }
                            }
                        }
                    });
                ...
                c.on("dragEnd", function (f) {
                    ...
                    if (r != null) {
                        b._raiseEvent(7, {label: r.label, value: r.value, originalEvent: f.args})
                    }
                    return false
                })
