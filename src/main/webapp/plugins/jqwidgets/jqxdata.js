...
(function (i) {
    i.jqx.observableArray = function (e, J) {
        ...
        I.unshift = function () {
            ...
            if (typeof H === "function") {
                H({object: I, type: "add", index: 0, name: "length", newValue: K.length, oldValue: M})
            }
            return K.length
        };
        I.shift = function () {
                                        ...
                                        for (var ax = 0; ax < ad; ax++) {
                                            ...
                                            if (aw != undefined && (aw.name == ay)) {
                                                ...
                                                if (aw != undefined && aw.map && (aw.map.indexOf(ay) >= 0)) {
                                                    ...
                                                    if (aE != "string") {
                                                        aF = ah.getvaluebytype(aF, {type: aE})
                                                    }
                                                    ak[ aC ] = aF;
                                                    if (ak[ aC ] != undefined) {
                                    ...
                                    if (av) {
                                        ...
                                        if (an[ ay ].subscribe) {
                                            ...
                                            ah.koSubscriptions[ ah.koSubscriptions.length ] = an[ ay ].subscribe(function (aI) {
                                                var aH = aA;
                                                ak[ ay ] = aI;
                                                var aJ = {index: aH, oldrecord: ak, record: ak};
                                ...
                                if (ah._oldrecords) {
                                    ...
                                    if (aa == "update") {
                                        if (ah._oldrecords[ aj ]._koindex != ao) {
                                            var aq = {index: aj, oldrecord: ah._oldrecords[ aj ], record: ak};
                        ...
                        if (aa == "add") {
                            ...
                            if (aa == "remove") {
                                ...
                                for (var Z = 0; Z < M; Z++) {
                                    ...
                                    if (!ah.records[ Z ]) {
                                        ah._changedrecords.push({index: Z, oldrecord: P, record: null})
                                    } else {
    ...
    i.extend(i.jqx.data, {
        ...
        ajaxSettings: {
            ...
            converters: {"* text": window.String, "text html": true, "text json": i.parseJSON, "text xml": i.parseXML},
        ...
        ajax: function (M, J) {
            ...
            J = J || {};
            var P, ad, K, Y, R, V, I, X, Q = i.jqx.data.ajaxSetup({}, J), af = Q.context || Q, T = af !== Q && (af.nodeType || af instanceof i) ? i(af) : i.event, ae = i.Deferred(), aa = i.Callbacks("once memory"), N = Q.statusCode || {}, U = {}, ab = {}, L = 0, O = "canceled", W = {
                readyState: 0,
