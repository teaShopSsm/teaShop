...
(function (b) {
    ...
    b.extend(b.jqx._jqxDataTable.prototype, {
        defineInstance: function () {
            ...
            this.dataview.update = function (y) {
                ...
                if (g.groups && g.groups.length > 0) {
                    ...
                    g.source.records.sort(function (E, D) {
                        if (E === undefined) {
                            E = null
                        }
                        if (D === undefined) {
                        ...
                        E = E.toString();
                        D = D.toString();
                        if (b.jqx.dataFormat.isNumber(E) && b.jqx.dataFormat.isNumber(D)) {
                            if (E < D) {
                                return -1
                            }
                            if (E > D) {
                            ...
                            if (b.jqx.dataFormat.isDate(E) && b.jqx.dataFormat.isDate(D)) {
                                if (E < D) {
                                    return -1
                                }
                                if (E > D) {
                    ...
                    if (p.records && p.records.length > 0) {
                        var t = function (D) {
                            for (var E = 0; E < D.length; E++) {
                                ...
                                g.rowsByKey[ D[ E ].uid ] = D[ E ];
                                if (D[ E ].records && D[ E ].records.length > 0) {
                                    t(D[ E ].records)
                                }
                            }
                        };
            ...
            if (l > c) {
                return this.vScrollBar.jqxScrollBar("setPosition", 4 + l - e - m)
            }
        ...
        }, setCellValueByKey: function (D, s, w) {
            var o = this;
            var j = this.rowsByKey[ D ];
            var k = this.getrowindex(j);
            var h = j;
            if (h != null && h[ s ] == w) {
                return false
            }
            if (h != null && h[ s ] === null && w === "") {
                return
            }
            var n = "";
            if (h != null && h[ s ] !== w) {
                var e = this.getColumn(s);
                var f = "string";
                var A = this.source.datafields || ((this.source._source) ? this.source._source.datafields : null);
                if (A) {
                    var t = "";
                    b.each(A, function () {
                ...
                n = h[ s ];
                if (!e.nullable || (w != null && w !== "" && e.nullable && w.label === undefined)) {
                ...
                h[ s ] = w;
                if (this.treeGrid) {
                    var r = this.treeGrid.getRow(D);
                    if (r) {
                        r[ s ] = w
                    }
                }
                if (w != null && w.label != null) {
                    var e = this.getColumn(s);
                    h[ e.displayfield ] = w.label;
                    h[ s ] = w.value;
                    if (this.treeGrid) {
                        var r = this.treeGrid.getRow(D);
                        if (r) {
                            r[ e.displayfield ] = w.label;
                            r[ s ] = w.value
                        }
                    }
                }
            ...
            if (this.source && this.source._knockoutdatasource && !this._updateFromAdapter && this.autokoupdates) {
                if (this.source._source._localdata) {
                    var y = k;
                    var v = this.source._source._localdata()[ y ];
                    this.source.suspendKO = true;
                    var l = v;
                    if (l[ s ] && l[ s ].subscribe) {
                        if (w != null && w.label != null) {
                            l[ e.displayfield ](w.label);
                            l[ s ](w.value)
                        } else {
                            l[ s ](w)
                        }
                    } else {
                        var A = this.source._source.datafields;
                        var d = null;
                        var B = null;
                        if (A) {
                            b.each(A, function () {
                        ...
                        if (B == null) {
                            ...
                            var g = B.split(this.source.mapChar);
                            if (g.length > 0) {
                                var c = l;
                        ...
                        this.source._source._localdata.replace(v, b.extend({}, l))
                    }
            ...
            if (this.source.updaterow && (sync == undefined || sync == true)) {
                ...
                var q = function (p) {
                    if (false == p) {
                        this.setCellValue(j, s, n, true, false)
                    }
                };
                try {
                    var i = D;
                    m = this.source.updaterow(i, h, q);
                    if (m == undefined) {
                        m = true
                    }
                } catch (x) {
                    m = false;
                    this.setCellValue(j, s, n);
                    return
                }
            }
            var C = this.getrowdisplayindex(j);
            var e = this.getColumn(s);
            ...
            return e
        }, beginroweditbykey: function (G, q) {
            if (this.beginEdit) {
                var A = this.beginEdit(G, q);
                if (A === false) {
                    return false
                }
            }
            var D = !this.treeGrid ? this.groups.length : this.source._source.hierarchy && this.source._source.hierarchy.groupingDataFields ? this.source._source.hierarchy.groupingDataFields.length : 0;
            if (D > 0) {
                var m = this.rowsByKey[ G ];
                if (this.treeGrid) {
                    var m = this.treeGrid.getRow(G)
                }
                if (m.level < D) {
                    return false
                }
            ...
            if (this._lastSelectedKey == null) {
                this.selectrowbykey(G)
            }
            if (this.editKey === G && this.editKey != undefined) {
                return false
            }
            if (this.rowinfo[ G ] && this.rowinfo[ G ].locked) {
                return false
            }
            if (this.editKey != null) {
                this.endroweditbykey(G, true);
                return false
            }
            var E = this.editSettings.editSingleCell;
            if (!q && E && this.columns.records && this.columns.records.length > 0) {
            ...
            var C = this._getuirow(G);
            var s = this._getpinneduirow(G);
            ...
            if (C) {
                ...
                for (var y = 0; y < h.length; y++) {
                    ...
                    if (E && q && g.datafield != q.datafield) {
                        continue
                    }
                    ...
                    var r = this.getCellTextByKey(G, g.displayfield);
                    ...
                    switch (g.columntype) {
                        ...
                        case"default":
                            ...
                            j[ 0 ].onfocus = function (i) {
                                setTimeout(function () {
                                    if (i) {
                                        var H = b(i.target).parent().parent().index();
                                        if (H >= 0) {
                                            o.ensureColumnVisible(o.columns.records[ H ].datafield)
                                        }
                                    } else {
                                        var H = b(document.activeElement).parent().parent().index();
                                        if (H >= 0) {
                                            o.ensureColumnVisible(o.columns.records[ H ].datafield)
                                        }
                                    }
                            ...
                            if (!g.editable) {
                                ...
                                if (!p) {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        try {
                                            if ("selectionStart" in c[ 0 ]) {
                                                c[ 0 ].setSelectionRange(0, I)
                                            } else {
                                                var i = c[ 0 ].createTextRange();
                                                i.collapse(true);
                                                i.moveEnd("character", I);
                            ...
                            if (g.createeditor) {
                                var B = r;
                                var r = this.getCellValueByKey(G, g.displayfield);
                                g.createeditor(!this.treeGrid ? n : G, r, j, B, w, t)
                            }
                            ...
                            if (g.cellsFormat != "") {
                                if (g.cellsFormat.indexOf("p") != -1 || g.cellsFormat.indexOf("c") != -1 || g.cellsFormat.indexOf("n") != -1 || g.cellsFormat.indexOf("f") != -1) {
                                    j.keydown(function (H) {
                                        var N = H.charCode ? H.charCode : H.keyCode ? H.keyCode : 0;
                                        var K = String.fromCharCode(N);
                                        var L = parseInt(K);
                                        if (isNaN(L)) {
                                            return true
                                        }
                                        ...
                                        if (g.cellsFormat.length > 1) {
                                            var M = parseInt(g.cellsFormat.substring(1));
                                            if (isNaN(M)) {
                                                M = 0
                                            }
                                        } else {
                                        ...
                                        if (M > 0) {
                                            if (I.indexOf(o.gridlocalization.decimalseparator) != -1) {
                                                if (o._selection(j).start > I.indexOf(o.gridlocalization.decimalseparator)) {
                                                    return true
                                                }
                                            }
                                        }
                                        for (var O = 0; O < I.length - M; O++) {
                                            var i = I.substring(O, O + 1);
                                            if (i.match(/^[0-9]+$/) != null) {
                                                J += i
                                            }
                                        }
                            ...
                            if (g.initeditor) {
                                var B = r;
                                var r = this.getCellValueByKey(G, g.displayfield);
                                g.initeditor(!this.treeGrid ? n : G, r, j, B, w, t)
                            }
                            break;
                        case"custom":
                        case"template":
                            ...
                            if (g.columntype == "custom") {
                                var z = this.editorsCache[ "customeditor_" + x + "_" + G ]
                            }
                            var B = r;
                            var r = this.getCellValueByKey(G, g.displayfield);
                            if (!z) {
                                ...
                                if (g.columntype != "custom") {
                                    ...
                                    this.editorsCache[ "customeditor_" + x + "_" + G ] = j
                                }
                                j.appendTo(k);
                                if (g.createeditor) {
                                    g.createeditor(!this.treeGrid ? n : G, r, j, B, u, t)
                                }
                            } else {
                                var j = z;
                                j.width(u);
                            ...
                            if (g.initeditor) {
                                g.initeditor(!this.treeGrid ? n : G, r, j, B, u, t)
                            }
                            this._editors.push({column: g, editor: j});
                            break
                    }
            ...
            this.editKey = G;
            this.beginUpdate();
            var F = this.getrowdisplayindex(m);
            this._raiseEvent("rowBeginEdit", {key: G, index: F, boundIndex: n, row: this.rowsByKey[ G ]});
            if (E) {
                var m = this.rowsByKey[ G ];
                var v = null;
                var l = null;
            ...
            if (p != undefined) {
                ...
                var g = function (t, e, y, r) {
                    if (t._loading) {
                        throw new Error("jqxDataTable: " + t.loadingErrorMessage);
                        return false
                    }
                    var q = t.vScrollInstance.value;
                    var x = false;
                    if (!b.isArray(y)) {
                        y.uid = e;
                        t.rowsByKey[ e ] = y;
                        ...
                        x = t.source.addRecord(y, r, n, i)
                    } else {
                        b.each(y, function (z, A) {
                            var B = null;
                            if (e != null && e[ z ] != null) {
                                B = e[ z ]
                            }
                            ...
                            x = t.source.addRecord(this, r, n, i)
                        })
                    }
                    if (t.groups && t.groups.length > 0) {
                        ...
                        t.source.records.sort(function (A, z) {
                            if (A === undefined) {
                                A = null
                            }
                            if (z === undefined) {
                            ...
                            A = A.toString();
                            z = z.toString();
                            if (b.jqx.dataFormat.isNumber(A) && b.jqx.dataFormat.isNumber(z)) {
                                if (A < z) {
                                    return -1
                                }
                                if (A > z) {
                                ...
                                if (b.jqx.dataFormat.isDate(A) && b.jqx.dataFormat.isDate(z)) {
                                    if (A < z) {
                                        return -1
                                    }
                                    if (A > z) {
                    ...
                    t.dataview._filteredData = null;
                    t.dataview._sortData = null;
                    t.dataview._sortHierarchyData = null;
                    if (t._updating == undefined || t._updating == false) {
                        t.refresh()
                    }
                    if (t.source && t.source._knockoutdatasource && !t._updateFromAdapter && t.autokoupdates) {
                        if (t.source._source._localdata) {
                            t.source.suspendKO = true;
                            t.source._source._localdata.push(y);
                            t.source.suspendKO = false
                        }
                    }
                    t.vScrollInstance.setPosition(q);
                    return x
                };
                        ...
                        if (f.pinned) {
                            ...
                            if (this.filterrow) {
                                if (this.filterrow[ 0 ].cells) {
                                    filtercell = this.filterrow[ 0 ].cells[ w ]
                                }
                            }
                            if (!this.rtl) {
                                var c = q[ 0 ].cells[ w ];
                                ...
                                if (this.filterrow && filtercell) {
                                    filtercell.style.marginLeft = h + "px"
                                }
                            } else {
                                var c = q[ 0 ].cells[ w ];
                                ...
                                if (this.filterrow && filtercell) {
                                    filtercell.style.marginLeft = -parseInt(u) + "px"
                                }
                            }
                        }
                    }
            ...
            b.each(this.columns.records, function (J, H) {
                ...
                var K = !self.rtl ? 250 + v - 1 : 250 + v + 1;
                var F = !r.rtl ? v-- : v++;
