...
(function (a) {
    ...
    a.extend(a.jqx._jqxTreeGrid.prototype, {
        defineInstance: function () {
            ...
            if (c == "pageSizeMode" || c == "hierarchicalCheckboxes") {
                b._renderrows()
            }
            ...
            if (f) {
                ...
                e._raiseEvent("rowCheck", {key: c, row: f.row})
            } else {
                var h = this.getRow(c);
                if (h) {
                    e.rowinfo[ c ] = {row: h, checked: true};
                    e.rowinfo[ c ].row[ g.checked ] = true;
                    if (h.originalRecord) {
                        e.rowinfo[ c ].originalRecord = h.originalRecord
                    }
                    e._raiseEvent("rowCheck", {key: c, row: h});
                    if (b == undefined && this.hierarchicalCheckboxes) {
                        this.checkRows(h, h)
                    }
                    if (d !== false) {
            ...
            if (g) {
                ...
                var i = this.getRow(c);
                if (i) {
                    f.rowinfo[ c ] = {row: i, checked: null};
            ...
            if (g) {
                ...
                f._raiseEvent("rowUncheck", {key: c, row: g.row})
            } else {
                var i = this.getRow(c);
                if (i) {
                    f.rowinfo[ c ] = {row: i, checked: false};
                    f.rowinfo[ c ].row[ h.checked ] = false;
                    if (i.originalRecord) {
                        f.rowinfo[ c ].originalRecord = i.originalRecord
                    }
                    f._raiseEvent("rowUncheck", {key: c, row: i});
                    if (b == undefined && this.hierarchicalCheckboxes) {
                        this.checkRows(i, i)
                    }
                    if (d !== false) {
            ...
            if (f) {
                ...
                if (!d.updating()) {
                    ...
                    d._renderhorizontalscroll();
                    d._raiseEvent("rowCollapse", {row: f.row, key: c})
                }
            }
        }
    })
